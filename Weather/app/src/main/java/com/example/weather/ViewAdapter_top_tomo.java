...
public class ViewAdapter_top_tomo extends FragmentStateAdapter {
    ...
    public ViewAdapter_top_tomo(@NonNull FragmentActivity fragmentActivity, int count,
                                String s, String s1, String s2, String gender) {
        super(fragmentActivity);
        mCount = count;
        top1 = s; top2 = s1; top3 = s2;
        this.gender = gender;
    ...
    public Fragment createFragment(int position) {
        ...
        if(index == 0) return new FirstTop_tomo(top1,num1);
        else if(index == 1)return new SecondTop_tomo(top2, num2);
        else return new ThirdTop_tomo(top3, num3);
    }
