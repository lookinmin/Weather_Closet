...
public class ViewAdapter_bottom extends FragmentStateAdapter {
    ...
    public ViewAdapter_bottom(@NonNull FragmentActivity fragmentActivity, int count, String s, String s1, String s2, String gender)
    {
    ...
    public Fragment createFragment(int position) {
        ...
        if(index == 0) return new FirstBottom(bottoms1, num1);
        else if(index == 1)return new SecondBottom(bottoms2, num2);
        else return new ThirdBottom(bottoms3, num3);
    }
